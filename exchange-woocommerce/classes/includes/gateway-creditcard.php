...
final class WC_Payment_Gateway_Creditcard extends WC_Payment_Gateway
{
    public function __construct()
    {
        $this->id = PAYMENTGATEWAY_EXTENSION_UID_PREFIX . 'creditcard';
        $this->method_title = PAYMENTGATEWAY_EXTENSION_NAME . ' CreditCard';
        $this->method_description = 'Credit Card transactions.';
        ...
        add_action('woocommerce_api_wc_payment_gateway_creditcard', [$this, 'process_callback']);
    ...
    public function process_payment($orderId)
    {
        ...
        $callbackUrl = str_replace( 'https:', 'http:', add_query_arg( 'wc-api', 'WC_Payment_Gateway_Creditcard', home_url( '/' ) ) );
    ...
    public function init_form_fields() {
	    ...
	    'publicKey' => [
                ...
                'description' => 'Public Integration Key (e.g. for payment.js)',
                'default' => '',
            ],
        ];
    }
